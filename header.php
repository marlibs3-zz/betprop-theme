<div class="container-header">
        ...
        <div class="grid_10 omega right">
            <div class="header-link">
                <ul class="header-menu">
                    <li><a href="/signup">
                            <div class="button header green">Sign up Free</div>
                        </a></li>
    ...
    <div class="desktop-hide">
        ...
        <a href="/"><img src="https://betterproposals.io/img/layout/logo-black.png" class="header-logo"
                         alt="Better Proposals"/></a>
